...
while($row = mysql_fetch_array($result))
  ...
  echo "<h1  style=color:#FF0000>前区         
   </>";

  echo $row['xh5'] . " " ;         
                   //$row['xh5']  xh5是数据库表中的列 名称                    echo "<br />";
  }
...
<a href="dlt_myaql_999999999999999999.php" style="font-size:35px;">开始选号</a>
